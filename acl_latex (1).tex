...
totaling 3,789 sentences, plus 62 minimal pairs across nine
...
Indic-trained tokenizers reverse that penalty. On MILU
...
\begin{itemize}
    \item A fertility audit of nine tokenizers across 3,789 sentences
...
3,789 sentences in total: 789 native formal, 1,000 native informal,
1,000 romanized informal, and 1,000 English Wikipedia sentences.
...
each tokenizer across the four corpus registers.
\begin{table}[H]
\centering
\resizebox{\columnwidth}{!}{%
\begin{tabular}{@{}lrrrr@{}}
...
moderate fertility of 3.25. Claude Haiku~4.5 scores 60.78\% despite
...
My corpus of 3,789 sentences is large enough for significance
...
tokenizers and four corpus registers. My findings answer all
...
60.78\%. That gap is the clearest evidence in the paper that the
